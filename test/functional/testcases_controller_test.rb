...
class TestcasesControllerTest < ActionController::TestCase
  ...
  test "should create testcase" do
    assert_difference('Testcase.count') do
      post :create, testcase: { automated: @testcase.automated, expected_results: @testcase.expected_results, repro_steps: @testcase.repro_steps, title: @testcase.title }
    end
  ...
  test "should update testcase" do
    put :update, id: @testcase, testcase: { automated: @testcase.automated, expected_results: @testcase.expected_results, repro_steps: @testcase.repro_steps, title: @testcase.title }
    assert_redirected_to testcase_path(assigns(:testcase))
  end
